# -*- coding: utf-8 -*-
"""
Created on Wed Jul 25 15:55:07 2018
...
samps=np.load('D:/pbl/samplist.npy')
anns=np.load('D:/pbl//atrslist.npy')
...
np.save('D:\\pbl\\labels.npy',np.array(ls))
np.save('D:\\pbl\\samples.npy',np.array(ss))
#--------------------小波变换-----------------
...
plt.show()
plt.plot(range(len(cA1)),wavesamp)
plt.show()
